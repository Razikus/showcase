...
import TrustLevelRenderer from "../components/TrustLevelRenderer.vue";
...
const colDefs = ref([
  ...
  { field: "trustlevel_sg1", cellRenderer: TrustLevelRenderer, filter: "agMultiColumnFilter" },
  { field: "trustlevel_sg2", cellRenderer: TrustLevelRenderer, filter: "agMultiColumnFilter" },
  { field: "trustlevel_sg3", cellRenderer: TrustLevelRenderer, filter: "agMultiColumnFilter" }
]);
